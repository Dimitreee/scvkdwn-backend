...
var syntaxPlugins = {
  ...
  // export
  '@babel/plugin-syntax-export-extensions': ['@babel/plugin-syntax-export-default-from', '@babel/plugin-syntax-export-namespace-from'] // to scoped packages
...
var helpers = {
  ...
  'babel-helpers': '@babel/helpers' // using null to specify "removed"
...
var misc = {
  ...
  'babel-types': '@babel/types' // 'babylon': '@babel/parser',

};
var plugins = Object.assign({
...
}, transformPlugins, syntaxPlugins, proposalPlugins);
var packages = Object.assign({}, plugins, presets, helpers, misc);
var latestPackages = new Set(Object.values(packages));
var stagePresets = Object.create(null);
stagePresets[3] = ["@babel/plugin-syntax-dynamic-import", "@babel/plugin-syntax-import-meta", "@babel/plugin-proposal-class-properties", "@babel/plugin-proposal-json-strings"];
stagePresets[2] = _toConsumableArray(stagePresets[3]).concat([["@babel/plugin-proposal-decorators", {
  "legacy": true
...
stagePresets[1] = _toConsumableArray(stagePresets[2]).concat(["@babel/plugin-proposal-export-default-from", "@babel/plugin-proposal-logical-assignment-operators", "@babel/plugin-proposal-optional-chaining", ["@babel/plugin-proposal-pipeline-operator", {
  "proposal": "minimal"
}], "@babel/plugin-proposal-nullish-coalescing-operator", "@babel/plugin-proposal-do-expressions"]);
stagePresets[0] = _toConsumableArray(stagePresets[1]).concat(["@babel/plugin-proposal-function-bind"]);
module.exports = {
  packages,
  presets,
  plugins,
